...
namespace addressbook_tests_autoit
{
    public class GroupHelper : HelperBase
    {
        ...
        {
            OpenGroupsDialogue();
            //aux.ControlClick(GROUPWINTITLE, "", "WindowsForms10.SysTreeView32.app.0.2c908d51");//выбор группы
            ...
            aux.ControlClick("Delete group", "", "WindowsForms10.BUTTON.app.0.2c908d53");//Подтверждение удаления
